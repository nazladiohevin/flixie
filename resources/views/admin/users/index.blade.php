...
@endsection
@section('content')
    <h1 class="font-bold text-3xl text-black mb-5">Users</h1>
    <a href="{{ route('users.create') }}" class="mb-4 w-max flex items-center gap-x-3 justify-center rounded bg-primary px-6 py-2 font-medium text-gray hover:bg-opacity-90">
                  ...
                  <td class="border-b border-[#eee] px-4 py-5">
                    <div class="flex items-center space-x-3.5">
                      ...
                      <form action="{{ route('users.destroy', $user) }}" method="post">
                        @csrf
                        @method("delete")
                        <button class="text-red-500 hover:scale-110 transition-all">
                          <svg class="fill-current size-6" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <a href="{{ route('users.edit', $user) }}" class="text-green-500 hover:scale-110 transition-all">
                        <svg xmlns="http://www.w3.org/2000/svg" class="size-6" viewBox="0 0 24 24"><g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><path d="M7 7H6a2 2 0 0 0-2 2v9a2 2 0 0 0 2 2h9a2 2 0 0 0 2-2v-1"/><path d="M20.385 6.585a2.1 2.1 0 0 0-2.97-2.97L9 12v3h3zM16 5l3 3"/></g></svg>
                      </a>
                    </div>
                  </td>
                </tr>                  
